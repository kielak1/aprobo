...
class ZleceniaTable(tables.Table):
...
class ZleceniaFilter(BaseDateRangeFilterSet):
...
class WszystkieZlecenia(LoginRequiredMixin, SingleTableMixin, FilterView):
    table_class = ZleceniaTable
    model = zlecenia_kontrolingowe
    template_name = "zlecenia-list.html"
    filterset_class = ZleceniaFilter
