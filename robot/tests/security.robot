...
Security
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/general/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/ideas/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/needs/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupydoakceptacji/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/wszystkiezakupy/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupy_roboczy/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupy_ezz/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupy_zakupy/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupy_bgnig/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/purchases/zakupy_realizacja/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
    ...
    Wait Until Page Contains    Logowanie
    Close Browser
    Open Browser    https://avanticdev.gas.pgnig.pl/edit_purchase_short/?purchase_id=1432    ${BROWSER}
    Maximize Browser Window
    Wait Until Page Contains    Logowanie
    Close Browser
